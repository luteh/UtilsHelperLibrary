...
object ValidationUtils {
    ...
    fun isEmpty(textView: TextView?): Boolean {
        if (textView?.visibility == View.VISIBLE) return isEmpty(
    ...
    fun isValidPassword(textView: TextView?): Boolean {
        if (textView?.visibility == View.VISIBLE) return isValidPassword(
            textView.text.toString()
        )
        else return true
    }
    ...
    fun isValidEmail(textView: TextView?): Boolean {
        if (textView?.visibility == View.VISIBLE) return isValidEmail(
            textView.text.toString()
        )
        else return true
    }
